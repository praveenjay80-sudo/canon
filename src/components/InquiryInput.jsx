...
export default function InquiryInput({ onGenerate, disabled }) {
  ...
  return (
    <div>
      <p className="text-xs text-stone-400 mb-2">Enter any field, topic, or concept — get the open questions that define the frontier and why they remain unsolved.</p>
      <div className="flex gap-2">
        <input
          ...
          placeholder="Enter any field or topic..."
          disabled={disabled}
