...
const EXAMPLES = [
  'Why do complex systems suddenly collapse?',
  'What is consciousness?',
  'Why does inequality persist across generations?',
  'How does memory work?',
  'What drives cultural change?',
  'What is time?',
];

export default function ConsilienceInput({ onGenerate, disabled }) {
  ...
  return (
    <div>
      <p className="text-xs text-stone-400 mb-2">Enter any question that crosses disciplinary lines — see what every field says and where they converge.</p>
      <div className="flex gap-2">
        <input
          ...
          placeholder="Enter a cross-disciplinary question..."
          disabled={disabled}
